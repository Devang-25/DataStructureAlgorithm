...
//You are given a string. You need to partition that string such that each substrings after partitioning would be palindromic string.
// You have to do this work with minimum number of partitioning.
